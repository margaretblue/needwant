...
window.bookmarklet({
    ...
    css : 	["http://localhost:3000/application-bookmarklet.css"],
    js  : 	[ "http://localhost:3000/bookmarklet.js"],
    ready : function(){
    ...
    if (baby_extras) {
      query_string += "&extras="+baby_extras;
		...
		var iframe = jq(document.createElement('iframe')).attr('allowtransparency', 'true').attr('src', 'http://localhost:3000/bookmarklet.js'+query_string).attr('name', 'babylist_iframe').attr('id', 'babylist_iframe').attr('scrolling', 'no');
